...
if __name__ == '__main__':
    ...
    parser.add_argument('--gif', type=int, default=11161)
    ...
    # load gif
    gif = GIF.fromFile('F:\\GIPHY\\Bronze\\%d.gif' % gif_num)

    # build a FaceData object for every face in each frame
    face_data = unpackJson('F:\\GIPHY\\Silver-3-PeopleData\\%d.json' % gif_num)
    target_dim = (256, 256)
    raw_snips = {}
    snips = {}
